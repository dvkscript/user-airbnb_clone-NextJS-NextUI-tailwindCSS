...
const FinishSetupPage = ({ params: {roomId} }: {params: {roomId: string}}) => {
    ...
    const { t } = useDictionary<"become-a-host", Dictionary["become-a-host"]["finish-setup"]>("become-a-host", (d) => d['finish-setup'])
        ...
        <div className='lg:content-center h-full'>
            <div className='max-h-fit flex flex-col-reverse lg:block md:px-12'>
                ...
                <div className='lg:inline-block lg:align-middle lg:w-1/2 text-left overflow-hidden'>
                    <div className='max-w-[46.5rem] max-h-[46.5rem] h-full overflow-hidden mx-auto lg:ml-0 p-1'>
                        <video
                            className='overflow-hidden object-cover border-none'
                            autoPlay
                            muted
                            playsInline
                            preload='auto'
                        >
                            <source src="/videos/become-a-host/finish-setup.mp4" type="video/mp4"/>
                        </video>
                    </div>
                </div>
            </div>
